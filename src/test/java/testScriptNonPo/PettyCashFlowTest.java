...
public class PettyCashFlowTest extends BaseClass{
	...
	@Test(priority = 1)
	public void pettyCashFlow() throws InterruptedException, AWTException {
...
//		financeAuthorizer.nonPoProcess_Option();
	...
	@Test(priority = 7,dependsOnMethods = "CFO2Flow")
	public void DCEO2Flow() throws AWTException, InterruptedException {
...
//		financeAuthorizer.nonPoProcess_Option();
	...
	@Test(priority = 8,dependsOnMethods = "DCEO2Flow")
...
//		financeAuthorizer.nonPoProcess_Option();
	...
	@Test(priority = 8,dependsOnMethods = "CEOFlow")
...
//		financeAuthorizer.nonPoProcess_Option();
		...
		financeAuthorizer.reconileButton();
