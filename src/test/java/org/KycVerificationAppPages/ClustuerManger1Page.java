...
public class ClustuerManger1Page {
    ...
    Actions mouse;
    Robot robot;
	public ClustuerManger1Page(WebDriver driver) throws AWTException {
	  ...
	  public void sendtoKYCOfficerbtn() throws InterruptedException {
			...
			WebElement sendToKycbtn=wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("(//flt-semantics[@role='button'])[14]"))));
			sendToKycbtn.click();
			Thread.sleep(1000);
		  }
}
