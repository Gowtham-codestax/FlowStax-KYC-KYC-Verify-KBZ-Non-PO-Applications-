...
public class Duplicate_Phone_Number_Online_Banking_ApplicationClosedTest extends BaseClass {
	
	@Test(priority = 1)
	public void Duplicate_Phone_Number_Online_Banking_applicationClose_FlowTest() throws AWTException, InterruptedException {
	...
	//  , dependsOnMethods = "Duplicate_Phone_Number_Online_Banking_applicationClose_FlowTest"
	@Test(priority = 2 , dependsOnMethods = "Duplicate_Phone_Number_Online_Banking_applicationClose_FlowTest")
