...
public class Phone_Change_ReqAndDevice_Change_ReqTest  extends BaseClass{

	
	@Test(priority = 1)
	public void Phone_Change_ReqAndDevice_Change_ReqPageFlowTest() throws AWTException, InterruptedException {
	...
	// , dependsOnMethods = "Phone_Change_ReqAndDevice_Change_ReqPageFlowTest"
		@Test(priority = 2 , dependsOnMethods = "Phone_Change_ReqAndDevice_Change_ReqPageFlowTest" )
