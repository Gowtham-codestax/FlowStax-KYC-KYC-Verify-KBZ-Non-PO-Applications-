...
public class Pin_Reset_Req_Device_Change_ReqTest extends BaseClass {

	
	@Test(priority = 1)
	public void Pin_Reset_Req_Device_Change_ReqPageFlowTest() throws AWTException, InterruptedException {
	...
	// , dependsOnMethods = "Pin_Reset_Req_Device_Change_ReqPageFlowTest"
	@Test(priority = 2 , dependsOnMethods = "Pin_Reset_Req_Device_Change_ReqPageFlowTest" )
